	...
	<div class="container">
		...
		<div class="container__data">
			...
			<div class="container__data-myself-character">
				{{ '使用角色:' + judgeCharacterName(missionUserCharacter) }}
			</div>
...
export default {
	...
	computed: {
		...
		missionUserStatus () {
			return this.myselfData.score.m3State === 0 ? '未完成' : Math.floor(this.myselfData.score.m3Time / 1000) + '秒'
		},
		missionUserIcon () {
			return this.myselfData.score.m3CharacterId === 0 ? '' : this.judgeIcon(this.myselfData.score.m3CharacterId)
		}
	},
	methods: {
		async initMap () {
